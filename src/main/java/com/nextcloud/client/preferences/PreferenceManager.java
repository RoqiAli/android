...
public final class PreferenceManager implements AppPreferences {
    ...
    public void setStoragePath(String path) {
        preferences.edit().putString(STORAGE_PATH, path).commit();
    }
     ...
     * commit is done on purpose to write immediately
     */
    public void removeKeysMigration() {
        preferences.edit().remove(PreferenceManager.PREF__KEYS_MIGRATION).commit();
    }
